...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center animate-slideInDown">
            ...
            <h2 className="text-3xl font-extrabold text-gray-900 animate-slideInUp animation-delay-100">Sign in to your account</h2>
            <p className="mt-2 text-sm text-gray-600 animate-fadeIn animation-delay-200">
              Or{' '}
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-white py-6 animate-fadeIn">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link to="/signup" className="text-gray-400 hover:text-indigo-400 transition-colors duration-300 text-sm">
                Sign Up
              </Link>
